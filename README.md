# MLEnd-Hums-and-Whistles-Miniproject
The mini-project consists of two components:  
Basic solution [6 marks]: Using the MLEnd Hums and Whistles dataset, build a machine learning pipeline that takes as an input a Potter or a StarWars audio segment and predicts its song label (either Harry or StarWars). 
